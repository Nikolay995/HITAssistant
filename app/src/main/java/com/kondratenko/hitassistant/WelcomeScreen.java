...
/**
 * Created by Manson on 05.12.2015.
 */
...
public class WelcomeScreen extends AppCompatActivity {
    ...
    private void endTutorial() {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //ищет в таске создаваемое Activity. Если находит, то открывает, а все, что выше – закрывает.
